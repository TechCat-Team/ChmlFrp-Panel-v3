...
export const FAQ_DATA: FAQItem[] = [
    ...
    },
    {
        ...
        content: `
            ...
            • 实名信息：使用经国家认证的SM2椭圆曲线公钥密码算法（GB/T 32918标准）对实名信息进行加密。加密私钥全程离线保管，平台仅使用公钥执行加密操作，自身无法进行任何解密，从而实现数据的单向安全隔离。同时，为满足合规检索与防重复实名等业务需要，平台采用SM3国密哈希算法（GB/T 32905标准）并部署多重强化防护机制存储一条实名数据的HASH值。HASH值采用国密算法和强盐值哈希，迭代次数远超行业标准，有效防止暴力破解。
                <br />
            • 密码信息：通过Bcrypt算法加密，无法反向解密。<br />
            <br />
